...
const neighborGroup = (values) => {
    ...
    const upGtone = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.nextGToneInScale)(gTone1, 1, scale);
    const downGtone = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.nextGToneInScale)(gTone1, -1, scale);
